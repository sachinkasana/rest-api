...
function Stopwatch() {
    ...
    _.bindAll(Stopwatch.prototype.start,Stopwatch.prototype.stop,Stopwatch.prototype.reset,Stopwatch.prototype.onTick,Stopwatch.prototype.formatTime,Stopwatch.prototype.getTime,Stopwatch.prototype.setTime);
};
...
Stopwatch.prototype.setTime = function (time) {
		this.time = time;
		return this.time;
};
